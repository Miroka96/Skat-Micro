...
class FailingReplyThrowable(
    ...
    companion object {
        ...
        fun invalidUsername(throwable: Throwable = NullPointerException("Username does not exist")): FailingReplyThrowable
                = FailingReplyThrowable(throwable, WebStatusCode.UNAUTHORIZED)

        fun invalidPassword(throwable: Throwable = AssertionError("Invalid Password Supplied")): FailingReplyThrowable
                = FailingReplyThrowable(throwable, WebStatusCode.UNAUTHORIZED)
    }
}